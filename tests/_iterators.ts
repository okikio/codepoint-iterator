...
/**
 * Iterate through iterable using `TextDecoder` (stream mode) and `String.protoype.codePointAt(...)` to get the codepoints
 */
export async function* textDecoderIterator<T extends Uint8Array>(
 ...
 * Iterate through iterable using `TextDecoder` (stream mode) and `String.protoype.codePointAt(...)` to get the codepoints
 */
export async function* ForTextDecoderIterator<T extends Uint8Array>(
  iterable: AsyncIterable<T> | Iterable<T>
) {
  const utf8Decoder = new TextDecoder("utf-8");
...
/**
 * `textDecoderIterator` but use the custom `codePointAt(...)` method instead of `String.protoype.codePointAt(...)`  
 */
export async function* textDecoderCustomCodePointAtIterator<T extends Uint8Array>(
  iterable: AsyncIterable<T> | Iterable<T>
) {
  const utf8Decoder = new TextDecoder("utf-8");
 ...
 * `textDecoderIterator` but use the custom `codePointAt(...)` method instead of `String.protoype.codePointAt(...)`  
 */
export async function* ForTextDecoderCustomCodePointAtIterator<T extends Uint8Array>(
  iterable: AsyncIterable<T> | Iterable<T>
) {
  const utf8Decoder = new TextDecoder("utf-8");
...
/**
 * `textDecoderIterator` but more complex, hopefully faster
 * 
 ...
 */
export async function* textDecoderComplexIterator<T extends Uint8Array>(
  iterable: AsyncIterable<T> | Iterable<T>
) {
  const utf8Decoder = new TextDecoder("utf-8");
 ...
 * @returns An async generator that yields Unicode code points.
 */
export async function* ForTextDecoderComplexIterator<T extends Uint8Array>(
  iterable: AsyncIterable<T> | Iterable<T>
) {
  const utf8Decoder = new TextDecoder("utf-8");
 ...
 * @returns An async generator that yields Unicode code points.
 */
export async function* ForAsCodePointsBufferWindowIterator<T extends Uint8Array>(
  iterable: AsyncIterable<T> | Iterable<T>
) {
  /**
   * - `byteSequence` stores the bytes of the current UTF-8 character being processed.
